...
class MM extends StatefulWidget {
  @override
  State<MM> createState() => MMState();
}

class MMState extends State<MM> {
  ...
  Card _buildProductList() {
    ...
    const ListTile productHeader =
        ListTile(title: Text('MysterConnect Premium'));
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                Text(
                  "${_products.first.price.replaceAll(_products.first.currencySymbol, "")} ${_products.first.currencyCode}",
          ...
          TextButton(
            ...
            onPressed: () {
              ...
              if (Platform.isAndroid) {
                ...
                print(oldSubscription.toString());
  ...
  GooglePlayPurchaseDetails? _getOldSubscription(
    ...
    if (productDetails.id == "mc_pre" && purchases["mc_pre"] != null) {
      oldSubscription = purchases["mc_pre"]! as GooglePlayPurchaseDetails;
    }
